namespace Properties_Kohnen_Christian
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            carnew.Make = "Jeep"; //assigns the value as Jeep
            carnew.Model = "Cherokee"; //assigns the value as Cherokee

            Console.WriteLine($"The make of the car is {carnew.Make} and the model of the car is {carnew.Model}"); //prints the two classes
